...
class SelectTest {
    private static Select Queries=new Select();

    @Test
    public void Count2017Test() {
    ...
    @Test
    public void FirstTwoVendorTest() {
        flywayWork.initialize();
